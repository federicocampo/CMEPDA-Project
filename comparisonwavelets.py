def twolvldecomp(im_path, wavelet):
    ...
    cA, (cH2, cV2, cD2), (cH1, cV1, cD1) = pywt.wavedec2(myim, wavelet, level=level) # Here I get my approximated image and the relative coefficients
...
def fourlvldecomp(im_path, wavelet):
    ...
    cA, (cH4, cV4, cD4), (cH3, cV3, cD3), (cH2, cV2, cD2), (cH1, cV1, cD1) = pywt.wavedec2(myim, wavelet, level=level) # Here I get my approximated image and the relative coefficients
...
image_path = r"C:\Users\feder\Desktop\Computational Methods for Experimental Physics and Data Analysis\IMAGES\Mammography_micro\Train\1\0088u1_2_1_1.pgm_3.pgm"

for i, wavelet_type in enumerate(['haar', 'sym2', 'sym3', 'db2', 'db3']):
    # Here I do the magic with pywavelets
    myim, mynewim = twolvldecomp(image_path, wavelet_type)
    ...
    image_name = f"twolevelswith{wavelet_type}.png"
    image_title = f"Altered with {wavelet_type}-2lvls"
